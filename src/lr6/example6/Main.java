...
public class Main {
    public static void main(String[] args) {
        ...
        int[] arrayIntReult1 = Main.getArray(arrayInt, 2);
        System.out.println(Arrays.toString(arrayIntReult1));

        int[] arrayIntReult2 = Main.getArray(arrayInt, 10);
        System.out.println(Arrays.toString(arrayIntReult2));
    }
