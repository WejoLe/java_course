...
public class WriteExcelFileExample {
    public static void main(String[] args) throws IOException {
        ...
        dataRow3.createCell(0).setCellValue("Жесткий диск");
        dataRow3.createCell(1).setCellValue("Объем 500 ГБ");
        dataRow3.createCell(2).setCellValue(1000.0);

        String filePath = "C:\\Users\\Evgeniy\\IdeaProjects\\Course1\\src\\Semestr2\\lab10\\Excel\\example.xlsx";
